...
The mess_with_emographics method did change the values of the munsters
hash since mutating methods where used.  Indexed assignment was use which
is destructive to the original musters hash object.
=end
