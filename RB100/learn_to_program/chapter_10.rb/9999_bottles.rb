...
while beer >= 2
  puts english_number(beer).capitalize + ' bottles of beer on the wall, ' + english_number(beer) + ' bottles of beer.'
  beer = beer - 1
  #  beer_str = beer.to_s  
  puts 'Take one down, pass it around, ' + english_number(beer) + ' bottles of beer on the wall...'
end
